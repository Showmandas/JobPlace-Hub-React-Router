...
const ShowJobDetails = ({ jobdata }) => {
  const { id, title, img, company, job_type_1, job_type_2, location, salary } =
    jobdata;
      ...
      <div className="card mb-3 h-100">
        <div className="row gy-2">
          <div className="col-md-4  d-flex justify-content-center align-items-center">
            <img
              src={img}
              className="img-fluid rounded m-auto w-50 py-5 "
              alt="..."
            />
          </div>
          <div className="col-md-4 d-flex justify-content-center align-items-center">
            <div className="card-body">
              ...
              <div className="d-flex justify-content-start gap-3">
                <button className="btn fw-semibold job_btn">
                  {job_type_1}
                </button>
                <button className="btn fw-semibold job_btn">
                  {job_type_2}
              ...
              <div className="d-flex justify-content-start mt-3 gap-2">
                ...
                <p style={{ color: "#757575" }}>
                  <img src={salaryimg} /> Salary : {salary}
                </p>
              </div>
            </div>
          </div>
          <div className="col-lg-4 d-flex justify-content-center align-items-center">
            <Link to={`/featureDetails/${id}`}>
              {" "}
              <button
                className="btn common w-100  text-white fw-semibold "
                id="detailsBtn"
              >
                View Details
              </button>
